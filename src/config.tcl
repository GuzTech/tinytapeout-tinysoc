...
set ::env(DESIGN_NAME) scan_wrapper_341244947682296404
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/cpu.v \
$::env(DESIGN_DIR)/user_module_341244947682296404.v \
$::env(DESIGN_DIR)/scan_wrapper_341244947682296404.v"
